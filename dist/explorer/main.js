...
var CurrentGameComponent = /** @class */ (function () {
    ...
    CurrentGameComponent.prototype.skipGame = function () {
...
/* harmony import */ var src_app_services_wiki_game_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/wiki-game.service */ "./src/app/services/wiki-game.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WelcomeComponent = /** @class */ (function () {
    function WelcomeComponent(store, game) {
        this.store = store;
        this.game = game;
    }
    ...
    WelcomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_ngxs_store__WEBPACK_IMPORTED_MODULE_2__["Store"], src_app_services_wiki_game_service__WEBPACK_IMPORTED_MODULE_4__["WikiGameService"]])
    ], WelcomeComponent);
...
var WikiApiService = /** @class */ (function () {
    ...
    WikiApiService.prototype.filterContent = function (text) {
        ...
        div.innerHTML = text.replace("{{{coat_alt}}}", "");
        //remove unwanted reference and navigations
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('#References, .reflist, [role="navigation"], sup, .reference, .ambox, #toc').remove();
        ...
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('a').each(function () {
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).get(0).setAttributeNS("http://www.mozilla.org/ns/specialspace", "routerLink", decodeURI(jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).attr('href')));
        ...
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('big').each(function () {
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).replaceWith("<span style=\"font-size: 1.1em\">" + jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).html() + "</span>");
        });
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('s, strike').each(function () {
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).replaceWith("<span style=\"text-decoration: line-through;\">" + jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).html() + "</span>");
        });
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('u').each(function () {
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).replaceWith("<span style=\"text-decoration: underline;\">" + jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).html() + "</span>");
        });
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('dir').each(function () {
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).replaceWith("<ul>" + jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).html() + "</ul>");
        });
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('tt').each(function () {
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).replaceWith("<span style=\"font-family: monospace\">" + jquery__WEBPACK_IMPORTED_MODULE_4___default()(this).html() + "</span>");
        });
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('acronym, applet, basefont, frame, frameset, isindex, noframes').remove();
        jquery__WEBPACK_IMPORTED_MODULE_4___default()(div).find('acronym, applet, basefont, frame, frameset, isindex, noframes').remove();
...
var WikiGameService = /** @class */ (function () {
     ...
     * Open the game
     */
    WikiGameService.prototype.openGame = function () {
        var _this = this;
        //create a new player
        this.createPlayer();
    ...
    Object.defineProperty(WikiGameService.prototype, "rank$", {
        get: function () {
            var _this = this;
            return this.fs.collection('players').valueChanges()
                ...
                var sortedPlayers = lodash__WEBPACK_IMPORTED_MODULE_5__["orderBy"](players, 'points', 'desc');
                // console.log(sortedPlayers);
                if (_this.player_id)
                    return lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"](sortedPlayers, { player_id: _this.player_id }) + 1;
                else
                    return -1;
            }));
        },
     ...
     * Skip current game
     */
    WikiGameService.prototype.skipGame = function () {
        return __awaiter(this, void 0, void 0, function () {
            var game;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.store.select(function (state) { return state.game.game; }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])(function (val) { return val != null; })).toPromise()];
                    case 1:
                        game = _a.sent();
                        this.games.unshift(game);
                        this.store.dispatch(new _store_actions_game_action__WEBPACK_IMPORTED_MODULE_2__["CreateGame"](this.games.pop()));
                        this.router.navigate(['']);
                        return [2 /*return*/];
                }
            });
